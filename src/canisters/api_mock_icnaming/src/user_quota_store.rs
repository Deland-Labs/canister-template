...
impl From<common::model::QuotaType> for QuotaType {
    fn from(q: common::model::QuotaType) -> Self {
        match q {
            common::model::QuotaType::LenEq(v) => QuotaType::LenEq(v),
            common::model::QuotaType::LenGte(v) => QuotaType::LenGte(v),
        }
    }
}
